# Generated by Django 2.2.16 on 2022-01-30 13:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, max_length=4000, verbose_name='информация о пользователе')),
                ('role', models.CharField(choices=[('admin', 'admin'), ('moderator', 'moderator'), ('user', 'user')], default='user', max_length=32, verbose_name='роль пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default='-пусто-', unique=True, verbose_name='URL категории')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(blank=True, validators=[reviews.validators.year_validator], verbose_name='Год издания')),
